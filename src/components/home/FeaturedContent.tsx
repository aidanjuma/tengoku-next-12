          ...
          <div className="text-white">
            ...
            <div className="h-32 lg:h-44 overflow-y-scroll">
              <p className="font-normal text-base text-left fix-justify">
                ...
                political value of his alter ego Momon are reaffirmed; the
                “hidden” genius of his actions is continuously met with shock
                and awe by Demiurge, Albedo, the rest of his guardians, and even
                Ains himself at his “great wisdom.” His attempts to act in a way
                befitting the ruler of Nazarick, continuing to further cement
                his guardian&apos;s loyalty, push him ever further down the path
                of not-so-intentional world domination. Without human conscience
                due to being undead, he is motivated only to continue searching
                for other players from Yggdrasil and to gain power to better
                protect the children and home of him and his forty former
                companions. Lord Ains Ooal Gown maintains his mantle of Overlord
                and leads the Great Tomb of Nazarick unto the world stage,
                directly into a vicious power struggle between two great
                empires.
              </p>
            </div>
          </div>
